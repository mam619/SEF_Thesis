...
ax.set_title('LSTM: Number of hidden layers vs. Number of neurons\n on the whole data set', fontsize = 16)
# Add a color bar which maps values to colors.
fig.colorbar(surf, shrink = 0.7, aspect = 10)
plt.tight_layout()
plt.show()
plt.savefig('Results_LSTM_n_neurons_n_hidden_all.png')
...
plt.tight_layout()
plt.show()
plt.savefig('Results_LSTM_n_neurons_n_hidden_spike.png')
...
plt.tight_layout()
plt.show()
plt.savefig('Results_LSTM_n_neurons_n_hidden_normal.png')
