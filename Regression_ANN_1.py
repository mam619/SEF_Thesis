...
regressor.add(Dense(output_dim = 11, init = 'normal', activation = 'relu', input_dim = 22))
...
regressor.fit(X_train, y_train, batch_size = 10, epochs = 100, validation_split=0.2)

# plot
print(regressor.regressor.keys())
plt.plot(regressor.regressor['loss'])
plt.plot(regressor.regressor['val_loss'])
