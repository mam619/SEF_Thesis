# =============================================================================
# # =============================================================================
# # Random Forest Regression WITH FS
# # =============================================================================
# =============================================================================
...
# import results from Feature selection
results_fs = pd.read_csv('Results_Random_Forest_Regression_FS.csv')
...
X = X.loc[:, ['APXP', 'TSDF', 'Im_Pr', 'In_gen', 'PrevDay', 'PrevWeek']]
...
results.to_csv('Results_Random_Forest_w_FS.csv')

# =============================================================================
# plot results for the end of 2018
# =============================================================================
...
plt.legend()
plt.tight_layout()
plt.savefig('Plot_Random_Forest_Regression_prediction_w_FS.png')
