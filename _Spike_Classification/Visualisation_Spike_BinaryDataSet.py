...
plt.title('Number of spike occurences for different roling windows', fontsize= fontsize + 2)
plt.minorticks_on()
plt.grid(which='major', linestyle='-', linewidth='0.5')
plt.grid(which='minor', linestyle=':', linewidth='0.5')
plt.legend(fontsize = fontsize)
...
# 2018
plt.figure(figsize=(15,5))
plt.plot(range_w, spike_var_18['num_spikes'], linewidth = 2, label = 'Number of SP with spike occurences', color = 'cornflowerblue')
plt.plot(range_w, spike_var_18['num_normal'], linewidth = 2, label = 'Number of SP under normal operation', linestyle = 'dashed', color = 'cornflowerblue')
plt.ylabel('Number of SP', fontsize = fontsize)
plt.xlabel('Window number (SP)', fontsize = fontsize)
plt.title('Number of SP with spike occurences and normal regions for the year of 2018 for different rolling windows', fontsize= 15)
plt.xticks(np.arange(0, 62, 2), fontsize = fontsize)
plt.yticks(fontsize = fontsize)
plt.xlim(0, 60)
...
ax1.set_title('Number of spikes per month for 2018, 2017 and 2019 and respective percentages', fontsize = fontsize + 2)
