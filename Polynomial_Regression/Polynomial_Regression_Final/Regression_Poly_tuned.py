# =============================================================================
# # =============================================================================
# # Polynomial Regression (multi-var)
# # =============================================================================
# =============================================================================
...
results.to_csv('Results_Polynomial_Regression.csv')
...
plt.title('Polynomial Regression predictions', fontsize = fontsize + 2)
plt.legend(loc = 'lower right')
plt.tight_layout()
plt.savefig('Plot_Polynomial_Regression_final.png')

y_pred = pd.Series(y_pred)
y_pred.to_csv('Prediction_Polynomial_Regression.csv')