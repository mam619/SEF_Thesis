# =============================================================================
#  3D graphs for n_hidden vs. neurons number for ANN
# =============================================================================
...
plt.tight_layout()
plt.show()
plt.savefig('3D_ANN_n_neurons_n_hidden_all.png')
...
plt.tight_layout()
plt.show()
plt.savefig('3D_ANN_n_neurons_n_hidden_spike.png')
...
plt.tight_layout()
plt.show()
plt.savefig('3D_ANN_n_neurons_n_hidden_normal.png')