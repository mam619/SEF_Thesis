# Obtain binary feature if offers have been accepted by Dinorwig plant - using API ELEXON
...
if __name__ == "__main__":
    ...
    data = post_elexon(
        "https://api.bmreports.com/BMRS/DETSYSPRICES/v1?APIKey=b297kkm9vfw946g&SettlementDate=2018-01-01&SettlementPeriod=3&ServiceType=xml"
    )
    ...
    for i in index[47103:]:
        ...
        sp = str(i)[8:]
        data = post_elexon(
            "https://api.bmreports.com/BMRS/DETSYSPRICES/v1?APIKey=b297kkm9vfw946g&SettlementDate={}-{}-{}&SettlementPeriod={}&ServiceType=xml".format(
                y, m, d, sp
            )
        )
        c = 0
    ...
    dino_bin.to_csv("bin_dinorwig.csv")
