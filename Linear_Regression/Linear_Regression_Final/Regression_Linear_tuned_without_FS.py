...
# =============================================================================
# Save coefficient values from regressor
# =============================================================================
coeff= pd.DataFrame({'Features': list(X.columns),
                     'Coefficients': regressor.coef_})
coeff = coeff.T

coeff['abs coeff'] = abs(coeff.Coefficients)

coeff.sort_values(by = 'abs coeff', ascending = False, inplace = True)

coeff.to_csv('Coefficients_of_Lin_Regression.csv')
...
results.to_csv('Results_Linear_Regression.csv')
...
plt.tight_layout()
plt.savefig('Plot_Linear_Regression_final.png')

y_pred = pd.Series(y_pred)
y_pred.to_csv('Prediction_Linear_Regression.csv')
